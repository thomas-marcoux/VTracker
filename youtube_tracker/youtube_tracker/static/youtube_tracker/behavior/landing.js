/*
	...
	Copyright © 1992 - 2018 HAYDEX, All Rights Reserved.
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    let searchButton = document.querySelector('section#theme button#startButton');
    ...
    searchBox.addEventListener('keypress', function(keyCode) {
        if (keyCode.which == 13) {
            window.location.href = "/home?q=" + searchBox.value.split(' ').join('+');
        }
    });
